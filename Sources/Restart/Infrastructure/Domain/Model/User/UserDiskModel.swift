...
extension UserDiskModel: Preparation {
    ...
    static func prepare(_ database: Fluent.Database) throws {
        try database.create(self) { creator in
            ...
            creator.parent(ImageDiskModel.self, name: Field.profileImageId, optional: true, unique: false)
            creator.parent(GenderDiskModel.self, name: Field.genderId, optional: true, unique: false)
            creator.string(Field.email, optional: true, unique: true)
            creator.parent(LocationDiskModel.self, name: Field.locationId, optional: true, unique: false)
            creator.parent(LocaleDiskModel.self, name: Field.localeId, optional: true, unique: false)
